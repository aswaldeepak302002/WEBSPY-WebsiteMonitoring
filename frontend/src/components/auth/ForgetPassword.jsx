...
const ForgetPassword = () => {
  ...
  return (
    <>
      <section className="flex flex-col md:flex-row h-screen items-center bg-stone-950">
        <div className=" hidden  w-full md:w-1/2 xl:w-2/3 h-screen">
        ...
        >
          <div className="w-full h-100">
            <div>
              ...
              <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12 text-blue-400">
                Forget Password
              </h1>
              {/* {error && (
          <div
            ...
            {error}
              ...
              >
                ...
                <Button
                  ...
                  className="w-full p-6 mt-6 dark:bg-blue-700 dark:text-white"
                >
                  Submit
                </Button>
              </form>
